    ...
    <div id="main" class="clearfix">
		...
		<div class="images-text-group">
			...
			<div class="images-right">
		    	...
		    	<img src="img/artwork/3i.jpg" alt="&copy;Paul Halliday from the series Close to Nowhere (forthcoming)"/>

		    	<div class="caption">&copy; Paul Halliday from the series Close to Nowhere (forthcoming)</div>
